...
async function createconfig() {
  ...
  const config = {
    ...
    projectName: "solution-onprem-wxai", // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-onprem-wxai/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              "https://github.com/ibm-client-engineering/solution-onprem-wxai/edit/main/${blogDirPath}/${blogPath}",
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-onprem-wxai",
